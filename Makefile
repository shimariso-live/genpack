...
genpack.zip: __main__.py qemu.py sudo.py \
	...
	util/__init__.py util/install-system-image util/expand-rw-layer util/do-with-lvm-snapshot util/build-kernel.py util/download.py util/rpmbootstrap.py util/with-mysql.py util/genbootstrap.py
